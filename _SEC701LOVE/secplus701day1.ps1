...
config t
   ...
   Int Vlan 1
     no shutdown
	 ip add 10.__.1.2 255.255.255.0
	 description MGMTDATA
   Int Vlan 10
     no shutdown
	 ip add 10.__.10.2 255.255.255.0
	 description WIRELESS
   Int Vlan 50
     no shutdown
	 ip add 10.__.50.2 255.255.255.0
	 description IPCCTV
   Int Vlan 100
     no shutdown
	 ip add 10.__.100.2 255.255.255.0
...
telephony-service
   ...
   max-ephones 5
   max-dn 20
   ip source-address 10.__.100.8 port 2000
   create cnf-files
ephone-dn 1
  number __11
ephone-dn 2
...
conf t
 ...
 NO ip route 10.__.0.0 255.255.0.0 200.0.0._
...
dial-peer voice 69 voip
 ...
 session target ipv4:10._.100.8
